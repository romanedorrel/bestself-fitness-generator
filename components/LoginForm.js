...
function LoginForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      //fetches response from credentials authenticator for signing into to app
      ...
      <div>
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            />
            <Link className="signup" href={"/resetpassword"}>
              Forgot Password?{" "}
              <span style={{ textDecoration: "underline" }}> Reset Here</span>
            </Link>
          </div>
